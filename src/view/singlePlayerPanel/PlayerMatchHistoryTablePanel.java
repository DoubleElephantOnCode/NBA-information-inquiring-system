...
public class PlayerMatchHistoryTablePanel extends JPanel{
	int width = SizeAndLocationAndFont.playerMatchHistoryPanelWidth,
			height = SizeAndLocationAndFont.playerMatchHistoryPanelHeight;
	...
	int tableWidth = SizeAndLocationAndFont.playerMatchHistoryTableWidth,
			tableHeight = SizeAndLocationAndFont.playerMatchHistoryTableHeight;
	int row = 30, column = 50;
	int pageRow = SizeAndLocationAndFont.playerMatchHistoryTablePageRow,
			pageColumn = SizeAndLocationAndFont.playerMatchHistoryTablePageColumn;
	
	int headListForRowPanelWidth = SizeAndLocationAndFont.playerMatchHistoryHeadListForRowWidth;
			
	int headListForColumnPanelHeight = SizeAndLocationAndFont.playerMatchHistoryHeadListForColumnHeight;
...
//		sortOUT.setImage(sortOUT.getImage().getScaledInstance(tableWidth / pageColumn, headListForColumnPanelHeight, Image.SCALE_DEFAULT));
		...
		this.setLocation(SizeAndLocationAndFont.playerMatchHistoryTableLocationX, SizeAndLocationAndFont.playerMatchHistoryTableLocationY);
